...
def harmonics_difference_evaluation():
    ...
    simple_hgm_diff = hgm_harmonics - nlsystem_harmonics
    lp_hgm_diff = hgm_lp_harmonics - nlsystem_lp_harmonics
    up_hgm_diff = hgm_up_harmonics - nlsystem_up_harmonics
...
harmonics_difference_evaluation()