...
def loudspeaker_evaluation_all(branches=3,Plot=False):
    ...
    load_sample = sumpf.modules.SignalFile(filename=os.path.join(source_dir,"wgn_gamma_18.npz"), format=sumpf.modules.SignalFile.WAV_FLOAT)
    ...
    found_filter_spec_adapt, nl_function_adapt = nlsp.adaptive_identification_powerseries(input_generator=input_noise,outputs=output_noise,iterations=1,branches=branches,
    ...
    # found_filter_spec_sineadapt, nl_function_sineadapt = nlsp.adaptive_identification_powerseries(input_generator=input_noise,outputs=output_noise,iterations=3,branches=branches,
    ...
    # found_filter_spec_cosadapt, nl_function_cosadapt = nlsp.adaptive_identification_powerseries(input_generator=input_noise,outputs=output_noise,iterations=3,branches=branches,
