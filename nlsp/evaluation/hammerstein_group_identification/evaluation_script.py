...
fade_out = 0.02
branches = 5
iden_method = [nlsp.nonlinearconvolution_chebyshev_cosine]
Plot = True
Save = False
...
for method in iden_method:
    ...
    #
    # nlsp.loudspeakermodel_evaluation("Sweep18","Speech2",branches,Plot,method,Save)
    # nlsp.distortionbox_evaluation("Sweep18","Speech1",branches,Plot,method,Save)
    #
    #
