...
def findfilter_evaluation(filter_frequencies):
    ...
    nlsystem = nlsp.HammersteinGroupModel_up(nonlinear_functions=nlsp.nonlinearconvolution_chebyshev_nlfunction(branches),
...
def sweep_evaluation(filter_frequencies):
    ...
    found_filter_spec = nlsp.nonlinearconvolution_chebyshev_filter(input_sweep,nlsystem.GetOutput(),[sweep_start_freq,
                                                                                                     sweep_stop_freq,
                                                                                                     branches])
    hgm = nlsp.HammersteinGroupModel_up(nonlinear_functions=nlsp.nonlinearconvolution_chebyshev_nlfunction(branches),
