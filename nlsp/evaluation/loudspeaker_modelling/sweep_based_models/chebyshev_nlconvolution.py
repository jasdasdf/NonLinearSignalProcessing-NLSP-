...
def loudspeakerevaluation():
    ...
    model = nlsp.HammersteinGroupModel_lp(nonlinear_functions=nlsp.nonlinearconvolution_chebyshev_nlfunction(branches),
    ...
    # model = nlsp.HammersteinGroupModel(nonlinear_functions=nlsp.nonlinearconvolution_chebyshev_nlfunction(branches),
    #                                filter_irs=kernel)
    ...
    iden = sumpf.modules.SignalFile(filename="C:/Users/Logeshwaran/Desktop/LS/iden_speech2",
                                      signal=model_up_highpass_signal,format=sumpf.modules.SignalFile.WAV_FLOAT)
    ref = sumpf.modules.SignalFile(filename="C:/Users/Logeshwaran/Desktop/LS/ref_speech2",
                                      signal=music_response,format=sumpf.modules.SignalFile.WAV_FLOAT)
    inp = sumpf.modules.SignalFile(filename="C:/Users/Logeshwaran/Desktop/LS/inp_speech2",
