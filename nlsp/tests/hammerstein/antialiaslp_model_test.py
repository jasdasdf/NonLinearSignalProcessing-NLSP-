...
def test_connectors():
    ...
    s_rate = 48000
    length = s_rate
    model = nlsp.AliasCompensatingHammersteinModelLowpass(nonlin_func=nlsp.NonlinearFunction.power_series(1))
...
def test_reliability():
    ...
    In lp filtering alias compensation the ouput energy should be less than the input energy
    """
